...
namespace Application.Convertors
{
    ...
    public class RenderViewToString : IViewRender
    {
        ...
        public string RenderToStringAsync(string viewName, object model)
        {
            ...
            using (var sw = new StringWriter())
            {
                ...
                var viewContext =
                    new ViewContext(actionContext, viewResult.View, viewDictionary, new TempDataDictionary(actionContext.HttpContext, _tempDataProvider), sw, new HtmlHelperOptions());
